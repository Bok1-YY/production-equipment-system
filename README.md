<div align="center">
  ...
  **面向工厂现场的设备全生命周期与维修闭环系统**
  ...
  永久设备编码 · 产线组合追溯 · 扫码报修 · 维修工单 · 技改任务 · 点检保养 · Android
...
扫码报修 → 接单 → 到场 → 维修 → 试运行 → 结单 → 评价
        ↓
技改任务 → 技术文件 → 全员确认 → 现场施工留证 → 管理员审核整单生效
        ↓
巡检 / 点检 / 保养 / 异常转维修
        ↓
...
| **技改任务闭环** | 管理员可用一张任务编排多台设备和多项产线调整、上传图纸并派多名技工；技工全员确认后到场施工、逐项填写结果和完工照片，管理员审核通过时才以单事务更新设备与产线。 |
...
| **设备技改／产线变动** | 管理员发布含技术文件、多变更项目和多执行人的方案；技工确认、到场、施工、上报偏差、逐项留证；管理员可退回整改或审核整单生效，审批冲突时全部回滚。 |
